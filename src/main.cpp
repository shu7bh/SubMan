...
int main(int argc, char *argv[])
{
    ...
    float vertices[] = {
        // FLOOR
        RIGHTFLOOR, UPFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b,
        RIGHTFLOOR, DOWNFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b,
        LEFTFLOOR, DOWNFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b,

        LEFTFLOOR, DOWNFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b,
        LEFTFLOOR, UPFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b,
        RIGHTFLOOR, UPFLOOR, Z, FLOOR_COLOR.r, FLOOR_COLOR.g, FLOOR_COLOR.b
    };
    ...
    float wall[] = {
        // Top wall
        LEFTFLOOR, UPWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, UPWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        RIGHTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, UPWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        // Bottom wall
        RIGHTFLOOR, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, DOWNWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        LEFTFLOOR, DOWNWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, DOWNWALL, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        // Left wall
        LEFTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTWALL, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        LEFTWALL, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTWALL, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        LEFTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        // Right wall
        RIGHTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTWALL, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,

        RIGHTWALL, DOWNFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTWALL, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b,
        RIGHTFLOOR, UPFLOOR, Z, WALL_COLOR.r, WALL_COLOR.g, WALL_COLOR.b
    };
    ...
    while (static_cast<int>(gs) != static_cast<int>(GameState::END))
    {
        ...
        while (isCollidingWithObstacles(p, PLAYERSIZE) || isCollidingWithEnemies(p, PLAYERSIZE * 9) || Coin::isCollidingWithCoins(p, PLAYERSIZE * 2))
            p = pos(PLAYERSIZE);
